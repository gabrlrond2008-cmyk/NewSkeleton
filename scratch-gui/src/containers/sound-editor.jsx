...
class SoundEditor extends React.Component {
    ...
    handlePlay () {
        if (!this.audioBufferPlayer) return;
        this.audioBufferPlayer.stop();
    ...
    copyCurrentBuffer () {
        ...
        if (this.audioBufferPlayer && this.audioBufferPlayer.buffer) {
            return {
    ...
    handleEffect (name) {
        if (!this.audioBufferPlayer || !this.audioBufferPlayer.buffer) return;
