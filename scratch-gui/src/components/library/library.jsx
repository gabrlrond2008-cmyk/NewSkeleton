...
class LibraryComponent extends React.Component {
    ...
    renderElement (data, index) {
        const itemKey = this.constructKey(data);
        const reactKey = `${itemKey}-${index}`;
        return (<LibraryItem
            ...
            isPlaying={this.state.playingItem === itemKey}
            key={reactKey}
            name={data.name}
        ...
        return Object.entries(dataByCategory)
            ...
            .map(([key, values]) =>
                ...
                >
                    ...
                    >
                        {values.map((item, idx) => this.renderElement(item, idx))}
                    </div>
                </div>));
    }
    render () {
